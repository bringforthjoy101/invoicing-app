...
const UserInfoCard = ({ selectedFeedback }) => {
  ...
  return (
        ...
        <Row className='my-2'>
          ...
          <Col md='7' xs='12'>
            ...
            <div className='user-info mt-2'>
              <CardText>
                <strong>Full Name</strong> : {selectedFeedback !== null ? `${selectedFeedback.name}` : 'Appia Admin'}
              </CardText>
              <CardText>
                <strong>Email</strong> : {selectedFeedback !== null ? selectedFeedback.email : 'appia.admin@appiawave.com'}
              </CardText>
              <CardText>
                <strong>Date Sent</strong> : {selectedFeedback !== null ? selectedFeedback.created_at : 'appia.admin@appiawave.com'}
              </CardText>
            </div>
            <hr />
            <h5 className='mb-0'>
              SUBJECT: {selectedFeedback !== null ? selectedFeedback.subject : 'Active'}
            </h5>
            <br />
            <CardText className='text-capitalize mb-0'>
              {selectedFeedback !== null ? selectedFeedback.message : 'Admin'}
            </CardText>
          </Col>
        </Row>
      </CardBody>
    ...
    //                   {selectedFeedback !== null ? selectedFeedback.id : ''}
    //                 </CardText>
    //               </div>
    ...
    //                 </div>
    //                 <CardText className='text-capitalize mb-0'>
    //                   {selectedFeedback !== null ? selectedFeedback.subject : 'Active'}
    //                 </CardText>
    //               </div>
    //               <div className='d-flex flex-wrap align-items-center my-50'>
    //                 <div className='user-info-title'>
